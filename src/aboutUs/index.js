        ...
        <body>
            <main>
                <div id="aboutUs">
                    ...
                    <img className="about-pics" alt="chase" src={require('../img/ChasePic.jpg')} />
                    ...
                    <img className="about-pics" alt="marie" src={require('../img/MariePic.jpg')} />
                    ...
                    <img className="about-pics" alt="stacey" src={require('../img/StaceyPic.jpg')} />
                    ...
                    <img className="about-pics" alt="francesco" src={require('../img/FrancescoPic.jpg')} />
